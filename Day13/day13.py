...
print("Minimum distance to (31,39): " + str(nodedistance[(31,39)]))
count = 0
for node in nodedistance:
    if nodedistance[node] <= 50:
        count += 1
print("Number of locations that can be reached in at most 50 steps: " + str(count))